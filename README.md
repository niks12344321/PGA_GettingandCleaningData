...
Getting and Cleaning Data - PGA - README
==========================================

* This readme file is for the course project of the Getting and Cleaning Data Coursera course.
...
*  The result is shown in the file `Final_tidy_dataset.txt`.
